...
// Model GUID (16 bytes)
#define AUDIO_MODEL_ID {0x16, 0x29, 0xaf, 0x35, 0xe5, 0x4e, 0x69, 0x41, 0x88, 0xcc, 0xd9, 0xd6, 0x58, 0x09, 0x20, 0xb3}
...
// data_in [3,40,101] (48480 bytes)
#define AUDIO_DATA_IN_RANK (3)
#define AUDIO_DATA_IN_SHAPE ((int[]){101, 40, 3})
#define AUDIO_DATA_IN_COUNT (12120)
#define AUDIO_DATA_IN_BYTES (48480)
...
#define AUDIO_DATA_OUT_SCALE 0
#define AUDIO_DATA_OUT_SYMBOLS { }

#define AUDIO_KEY_MAX (5)
...
// Profiling regions
#ifdef AUDIO_PROFILING
    #define AUDIO_REGIONS_COUNT 1
    #define AUDIO_REGIONS_NAMES {\
    	"AUDIO_3W_E2_PEAK_PREVIEW",\
    }
#else
