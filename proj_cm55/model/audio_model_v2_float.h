...
// Model GUID (16 bytes)
#define AUDIO_MODEL_ID {0xe0, 0xdf, 0x04, 0xfc, 0xf2, 0xfa, 0x7b, 0x4c, 0x86, 0x85, 0x52, 0x53, 0x17, 0x14, 0xc5, 0xcd}
...
#define AUDIO_DATA_IN_SHAPE ((int[]){101, 40, 1})
#define AUDIO_DATA_IN_COUNT (4040)
#define AUDIO_DATA_IN_BYTES (16160)
